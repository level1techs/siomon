...
/// Shared sensor labels for both X670E and B650E STRIX variants.
const STRIX_LABELS: &[(&str, &str)] = &[
...
pub static BOARD_X670: BoardTemplate = BoardTemplate {
    match_substrings: &["strix", "x670"],
    exclude_substrings: &[],
    match_vendor: &[],
    description: "ASUS ROG STRIX X670E (AMD AM5, NCT6798D)",
...
pub static BOARD_B650: BoardTemplate = BoardTemplate {
    match_substrings: &["strix", "b650"],
    exclude_substrings: &[],
    match_vendor: &[],
    description: "ASUS ROG STRIX B650E (AMD AM5, NCT6798D)",
    platform: Platform::Generic,
